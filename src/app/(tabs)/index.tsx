          ...
          <View style={styles.confirmationCard}>
            ...
            {pendingAction.operations.map((op: any, idx: number) => (
              <View key={idx} style={styles.confirmHighlightBox}>
                <Ionicons name="cube-outline" size={18} color="#0190A0" style={{marginRight: 6}} />
...
const styles = StyleSheet.create({
  ...
  header: { padding: 20, backgroundColor: '#0190A0', borderBottomWidth: 1, borderColor: '#eee' },
  ...
  userBubble: { backgroundColor: '#0190A0', alignSelf: 'flex-end', borderBottomRightRadius: 4 },
  ...
  sendButton: { backgroundColor: '#0190A0', paddingHorizontal: 20, paddingVertical: 12, borderRadius: 24, justifyContent: 'center', alignItems: 'center' },
  ...
  confirmHighlightText: { flex: 1, fontSize: 14, fontWeight: '600', color: '#0190A0' },
  ...
  btnSecondary: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 12, borderRadius: 8, borderWidth: 1, borderColor: '#0190A0' },
  btnSecondaryText: { color: '#0190A0', fontWeight: '600' },
  btnPrimary: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0190A0', padding: 12, borderRadius: 8 },
  btnPrimaryText: { color: '#FFFFFF', fontWeight: '600' },

  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
  modalContent: { backgroundColor: '#FFF', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24, paddingBottom: 40 },
  modalTitle: { fontSize: 20, fontWeight: 'bold', marginBottom: 20, color: '#0190A0' },
  ...
  stepperBtnText: { fontSize: 20, fontWeight: 'bold', color: '#0190A0' },
